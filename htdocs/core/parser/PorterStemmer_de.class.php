	...
	*/
	...
	class PorterStemmer_de {
        ...
        public function __construct() {
            require CORE_DIR . '/parser/stopwords.inc.php';
            // note: $STOPWORDS is from stopwords.inc.php
		...
		function stem($word) {
            ...
            if (array_key_exists(strtolower($word), $this->stopWords)) {
                return $this->postlude($word);
            }
		...
		*/
		...
		/*
		Prelude
		The original description says: Replace � by ss, and put u and y  between vowels into upper case.
		...
		*/
		...
		/*
		Postlude
		the umlaut accent will be removed from �, � and �, and U and Y will be turned back into lower case.
		*/
		function postlude($word) {
            $search =  array( 'ä', 'ö', 'ü', 'à', 'á', 'â', 'ç', 'è', 'é', 'ê', 'ë', 'ì', 'ò', 'ô', 'ó', 'ô', 'ù' );
			$replace = array( 'a', 'o', 'u', 'a', 'a', 'a', 'c', 'e', 'e', 'e', 'e', 'i', 'o', 'o', 'o', 'o', 'u' );
