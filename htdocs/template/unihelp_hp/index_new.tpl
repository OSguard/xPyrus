...
{* Start Red Box *}
<div style="border-left: #999 solid 1px; width: 50%; float: right; padding-left: 10px; margin-left: 10px">
	<div style="float: left; width: 99%; margin-bottom: -20px">
		<div style="min-height:100px;">
		{*<img src="template/unihelp_hp/css/images/weblogo.png" alt="UniHelp Logo" style="margin:15px;float:left;"/>*}
	...
	<h3>##index_newsUnpublished##</h3>
			<table class="centralTable">
				<tr style="border-bottom:1px solid #cfcfcf; width:100%;">
					<th style="padding-left:5px; padding-right:5px; width:60%">##index_heading##</th>
					<th style="padding-left:5px; padding-right:5px;">##index_organization##</th>
