...
*}{*	$Id: course_user_files.tpl 5807 2008-04-12 21:23:22Z trehn $
	$HeadURL: https://svn.unihelp.de:7823/unihelp_dev/v2/branches/xpyrus/htdocs/template/unihelp_hp/modules/course/course_user_files.tpl $	*}
{* <h2 id="pagename">{$user->getUsername()|genitiv} Unterlagen</h2> *}
