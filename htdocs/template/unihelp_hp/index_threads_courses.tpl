...
*}<div id="course-files" class="shadow ie6coursefiles">
<div class="nopadding">
<h4 class="someHead">Neue F&auml;cher-Eintr&auml;ge</h4>
<ul class="margin">
	{foreach from=$threads_course item=thread}
			<li class="course-thread">
			<span class="caption">{forum_link thread=$thread title="Zum Thread"} {forum_new thread=$thread}</span>
	...
	{foreachelse}
		<li>In Deinen Fächern ist einfach nix los.</li>		
	{/foreach}
</ul>
