...
ALTER TABLE __SCHEMA__.forum_thread_entries ADD COLUMN idx_fulltext tsvector;
CREATE INDEX __SCHEMA___forum_thread_entries_idx_fulltext ON __SCHEMA__.forum_thread_entries USING gist(idx_fulltext);

-- for logging table
-- ALTER TABLE __SCHEMA__.forum_thread_entries_log ADD COLUMN idx_fulltext tsvector;
